...
%% Read images
X = imread('coral.jpg'); %Source image
Y = imread('sunset.jpg'); %Target image
figure()
...
Y_new_ss = N * ot_map'* X_ss; %X_new_ss corresponds to X^_new in the report
B = pinv(Y_ss) * Y_new_ss;
Y_new_ = Y_ * B; %X_new_ corresponds to X' in the report
